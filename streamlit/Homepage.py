...
def add_bg_from_url():
    st.markdown(
         ...
         <style>
         .stApp {{
             background-image: url("https://wallpaper.dog/large/17116085.jpg");
...
rec_df = pd.read_pickle('../datasets/rec.plk')
option = st.selectbox(
"Select Anime ", rec_df[81:])
