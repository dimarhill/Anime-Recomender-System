...
def add_bg_from_url():
    st.markdown(
         ...
         <style>
         .stApp {{
             background-image: url("https://wallpaper.dog/large/17155337.jpg");
...
anime = anime[anime['type'] == 'Special']
...
rec_df = pd.read_pickle('../datasets/recspecial.plk')


col1, col2 = st.columns(2)
col1.header("Top Rated Specials")
...
col2.header("Top Watched Specials")
